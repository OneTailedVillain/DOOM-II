...
local function doLoadingShit()
	...
	if matchedGame == "srb2" then
		...
		print("SRB2 VER: ".. doom.srb2ver)
		if doom.srb2ver == 3 then
	...
	then
		...
		if matchedGame == "shareware" then
			...
			doom.titlemenus.episelect.entries = {
				...
				{label = "episode2", patch = "M_EPI2", x = 48, y = 63, goto = "sharewaredeny", episode = 2},
				{label = "episode3", patch = "M_EPI3", x = 48, y = 63, goto = "sharewaredeny", episode = 3},
			}
		end
	...
	if doom.isdoom1 then
		if matchedGame == "chex1" then
			...
			doom.textscreenmaps = {
				[8]  = {text = "$E1TEXT", secret = false, bg = "EP1CUTSC", postgraphic = "CREDIT"},
				[17] = {text = "$E2TEXT", secret = false, bg = "EP2CUTSC", postgraphic = "VICTORY2"},
				[26] = {text = "$E3TEXT", secret = false, bg = "EP3CUTSC", postcutscene = "sweetlittledeadbunny"},
				[35] = {text = "$E4TEXT", secret = false, bg = "EP4CUTSC", postgraphic = "ENDPIC"},
			}
			if doom.gamemode == "shareware" then
				doom.textscreenmaps[8].postgraphic = "HELP2"
			end
		end
	else
		doom.textscreenmaps = {
	...
	if matchedGame == "freedoom" then
		local string = "Freedoom"
		if not doom.isdoom1 then
			string = $ .. " II"
		end

		doom.strings["GAMENAME"] = string .. " v%i.%i"
	end
...
addHook("ThinkFrame", function()
	...
	shouldreprintgamename = true
	if startupstring == lastgamename then shouldreprintgamename = false return end
