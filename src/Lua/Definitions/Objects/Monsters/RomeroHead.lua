...
SafeFreeSlot("SPR_FIRE")

local name = "SpawnFire"
...
local states = {
    {frame = A|FF_FULLBRIGHT, tics = 4, action = A_DoomAFire},
    {frame = B|FF_FULLBRIGHT, tics = 4, action = A_DoomAFire},
    {frame = C|FF_FULLBRIGHT, tics = 4, action = A_DoomAFire},
    {frame = D|FF_FULLBRIGHT, tics = 4, action = A_DoomAFire},
    {frame = E|FF_FULLBRIGHT, tics = 4, action = A_DoomAFire},
    {frame = F|FF_FULLBRIGHT, tics = 4, action = A_DoomAFire},
    {frame = G|FF_FULLBRIGHT, tics = 4, action = A_DoomAFire},
    {frame = H|FF_FULLBRIGHT, tics = 4, action = A_DoomAFire},
}
