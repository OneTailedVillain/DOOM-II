...
local states = {
	...
	attack = {
		{action = A_DoomVileStart, frame = G, tics = 0},
		{action = A_DoomFaceTarget, frame = G, tics = 10},
		{action = A_DoomVileTarget, frame = H, tics = 8},
		...
		{action = A_DoomVileAttack, frame = O, tics = 8},
