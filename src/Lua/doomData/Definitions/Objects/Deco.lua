...
SafeFreeSlot("SPR_HDB1")
local name = "HangNoGuts"
...
SafeFreeSlot("SPR_HDB3")
local name = "HangTLookingDown"
...
SafeFreeSlot("SPR_HDB6")
local name = "HangTNoBrain"
...
SafeFreeSlot("SPR_HDB4")
local name = "HangTSkull"
