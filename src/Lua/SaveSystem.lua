...
doom.configents = {
	...
	thinmessages = {commandname = "doom_thinmessages", default = "Off", helpdescription = "Thin messages", possiblevalues = CV_OnOff},
	allcapsmessages = {commandname = "doom_allcapsmessages", default = "On", helpdescription = "Messages Are All Uppercase", possiblevalues = CV_OnOff},
	fpglitch = {commandname = "doom_flashpalbug", default = "Off", helpdescription = "Fix Hurt/Item Flashpals", possiblevalues = CV_OnOff},
	ouchglitch = {commandname = "doom_ouchfacebug", default = "Off", helpdescription = "Fix Ouchface Bug", possiblevalues = CV_OnOff},
