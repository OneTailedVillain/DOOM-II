...
dofile("Definitions/Objects/Projectiles/Cacodemon Shot.lua")
...
dofile("Definitions/Objects/Projectiles/BFG Ball.lua")
...
---@class doomcharcss_t
---@field name string Display name shown in character select / UI
---@field description string[] Multi-line description shown in CSS (character select screen)
---@field sprite spritenum_t Sprite used for preview/animation
---@field sequence table Animation sequence in format {frame, duration}

---@class doomarmorproperties_t
---@field armorclassmult integer Multiplier for armor class value (class 1 = green, class 2 = blue)
---@field armorclass1prot fixed_t Damage reduction for class 1 armor (green armor)
---@field armorclass2prot fixed_t Damage reduction for class 2+ armor (blue armor and above)

---@class doomammotable_t
---@field bullets? integer Bullet ammo count
---@field shells? integer Shell ammo count
---@field cells? integer Cell ammo count
---@field rockets? integer Rocket ammo count

---@class doompickupammo_t
---@field all fixed_t Global multiplier applied to all ammo pickups
---@field bullets? fixed_t Multiplier for bullet pickups
---@field shells? fixed_t Multiplier for shell pickups
---@field cells? fixed_t Multiplier for cell pickups
---@field rockets? fixed_t Multiplier for rocket pickups

---@class doompickuphealth_t
---@field all fixed_t Global multiplier applied to all health pickups
---@field medikit? fixed_t Multiplier for medikit pickups
---@field stimpack? fixed_t Multiplier for stimpack pickups

---@class doompickuppowerups_t
---@field all fixed_t Global multiplier applied to all powerups
---@field invisibility? fixed_t Multiplier for partial invisibility
---@field infrared? fixed_t Multiplier for light amp visor
---@field radsuit? fixed_t Multiplier for radiation suit
---@field invulnerability? fixed_t Multiplier for invulnerability sphere

---@class doompickupfactors_t
---@field ammo? doompickupammo_t Ammo pickup scaling
---@field health? doompickuphealth_t Health pickup scaling
---@field powerups? doompickuppowerups_t Power-up duration/effect scaling

---@class doomdamagefactor_t
---@field all fixed_t Global damage taken multiplier (applies to all damage types)

---@class doomcharproperties_t
---@field sounds table<integer, integer>? Sound override table (maps default sfx_* → replacement sfx_*)
---@field dealdamagefactor? fixed_t Multiplier for damage DEALT by the player (offensive scaling)
---@field damagefactor? doomdamagefactor_t Damage TAKEN multipliers (defensive scaling)
---@field movefactor integer Ground acceleration / movement responsiveness (higher = faster accel)
---@field walkfactor fixed_t Walking speed multiplier (affects slow movement state)
---@field jumpfactor? fixed_t Jump height multiplier
---@field mass? integer Player mass (affects knockback and physics interactions)
...
---@field weaponremapping? table<vanillaweps, string> What each weapon will remap to for this skin (vanilla system only)
---@field maxammo? doomammotable_t Maximum ammo capacities. Supercedes setting via vanillaoverrides
---@field pickupfactors? doompickupfactors_t Multipliers applied when receiving pickups

---@class doomvanillaweaponoverride_t : shortweapondef_t
-- Inherits all optional shortweapondef_t fields
---@field firesound? integer Sound played when firing
---@field hitsound? integer Sound played on hit (melee, etc.)

---@class doomvanillaoverrides_t
---@field ammo? table<string, ammodef_t?> Ammo overrides in ammodef format
---@field soulspheregive? integer Amount of health Soulsphere gives
---@field megaspheregive? integer Amount of health Megasphere gives
...
---@field vanillaoverrides? doomvanillaoverrides_t Overrides for certain in-engine values
---@field useDoomMovement? boolean If true, forces Doom-style movement instead of SRB2 physics
---@field forceDisableJump? boolean If true, disables jumping entirely
---@field noWeapons? boolean If true, disables Doom weapon system
---@field noHUD? boolean If true, disables Doom HUD
---@field intermusic? string Intermission music override
---@field noPartialInvisEffect? boolean Disables engine-provided invisibility effect
---@field methods doommethods_t Method overrides/hooks for this character
